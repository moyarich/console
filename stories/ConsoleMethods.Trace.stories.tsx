...
const method = "trace" as const;
const description = "Display a message and the captured JavaScript call stack.";
const expected = "Trace from the story";

function runExample(console: globalThis.Console) {
  console.trace("Trace from the story");
}
